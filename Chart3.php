...
$sql = "SELECT * FROM `oc_deck_cards` WHERE `duedate` BETWEEN '".$today_start."' AND '".$today_end."' AND NOT `deleted_at` AND NOT `archived`";
        ...
        ?>
                        ...
                        <li class="task-item sortable-chosen">
                            <div class="task-body">
                                ...
                                <div class="task-info">
                                    <div class="title">
                                        <a href="https://cloud.domain.com/apps/deck/#!/board/<?=$board[$row['stack_id']]?>//card/<?=$row['id']?>" target="_blank">
                                            <?= $row['title'] ?>
                                        </a>
                                    </div>
                                    <div class="categories-list">
                                        <strong>Besitzer:</strong> <?= $row['owner'] ?>
                                    </div>
                                </div>
